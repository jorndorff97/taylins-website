    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      {hasError ? (
        <div className="flex flex-col items-center justify-center py-16 px-4">
          ...
          <h2 className="text-xl font-semibold text-slate-900 mb-2">Messages Coming Soon</h2>
          <p className="text-slate-600 text-center mb-6 max-w-md">
            The messaging feature is being set up. In the meantime, browse our products and send offers to start conversations.
          </p>
          <Link
            href="/"
        ...
        <div className="flex flex-col items-center justify-center py-16 px-4">
          ...
          <p className="text-slate-600 text-center mb-6 max-w-md">
            Start a conversation by sending an offer on any product. The seller will respond to discuss details and negotiate.
          </p>
          <Link
            href="/"
            className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-6 py-3 text-sm font-medium text-white hover:bg-slate-800 transition-colors"
