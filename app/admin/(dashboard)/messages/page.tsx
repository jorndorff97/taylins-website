...
export default async function AdminMessagesPage() {
  ...
  return (
    <>
      ...
      <main className="flex-1 bg-background min-w-0 overflow-hidden">
          ...
          {allMessages.length === 0 ? (
            ...
            <div className="flex flex-col gap-2">
              {allMessages.map((msg) => (
                ...
                >
                  <div className="flex gap-4 p-4 rounded-xl bg-white border border-slate-200 transition-all hover:border-slate-300 hover:shadow-sm">
                    {msg.listingImage && (
                      <div className="h-14 w-14 flex-shrink-0 overflow-hidden rounded-lg bg-slate-50 border border-slate-100 p-1">
                        <img
