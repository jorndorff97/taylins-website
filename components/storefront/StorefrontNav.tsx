  ...
  return (
    <>
      <div className="flex items-center gap-4 sm:gap-7">
        {/* Desktop Links - Left side of the nav area */}
                    ...
                    <div className="py-2">
                      ...
                      {buyerId ? (
                        <>
                          <Link
                            href="/messages"
                            className="relative flex items-center justify-between px-5 py-3 text-sm text-slate-700 hover:bg-slate-50 transition-colors"
                            onClick={() => setIsMenuOpen(false)}
                          >
                            <span>Messages</span>
                            {unreadCount > 0 && (
                              <span className="flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-xs font-medium text-white shadow-sm">
                        ...
                        <>
                          ...
                          <Link
                            href="/signup"
                            className="block px-5 py-3 text-sm font-medium text-slate-900 hover:bg-slate-50 transition-colors"
                            onClick={() => setIsMenuOpen(false)}
                          >
                            Sign up
                          </Link>
                      ...
                      <Link
                        href="/admin"
                        className="flex items-center gap-2 px-5 py-3 text-sm text-slate-500 hover:bg-slate-50 transition-colors"
                        onClick={() => setIsMenuOpen(false)}
                      >
