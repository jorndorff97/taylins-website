    ...
    <div className="relative">
      <div className="relative group">
        ...
        <div
          ...
          className="flex gap-4 sm:gap-6 lg:gap-6 overflow-x-auto snap-x snap-mandatory scrollbar-hide"
        >
          {listings.map((listing, i) => (
            <div
              key={listing.id}
              className="snap-center shrink-0 w-[45vw] sm:w-[45%] lg:w-[calc(25%-1.5rem)]"
            >
